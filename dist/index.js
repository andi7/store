(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["store"] = factory(require("react"));
	else
		root["store"] = factory(root["react"]);
...
/***/ "./node_modules/utils/dist/index.js":
/*!******************************************!*\
  !*** ./node_modules/utils/dist/index.js ***!
  \******************************************/
/*! no static exports found */
...
var ResourceContext = _react.default.createContext('create');

var Provider = ResourceContext.Provider,
    Consumer = ResourceContext.Consumer;
...
var _default = function _default(_ref) {
  ...
  var _useContext = (0, _react.useContext)(_context.default),
      ...
      setBusy = _useContext.setBusy,
      getBusy = _useContext.getBusy,
      globalHeaders = _useContext.globalHeaders;

  var busyName = "delete".concat(name);
  ...
  var destroy = function destroy() {
    return new Promise(function (resolve, reject) {
      ...
      (0, _axios.default)({
        method: 'delete',
        url: "".concat(apiUrl, "/").concat(path.replace(/:(\w+)/, function (_, group) {
          return params[group];
        })),
        headers: _objectSpread({}, globalHeaders(), headers)
      }).then(function (response) {
        return resolve(response.data);
      }).catch(function (err) {
        return reject(err);
      }).finally(function () {
        return setBusy(busyName, false);
      });
    });
  };
  ...
  return _react.default.createElement(Provider, {
    value: {
      destroy: destroy,
      busy: getBusy(busyName)
    }
  }, _react.default.createElement(Consumer, null, children));
};
...
var _context2 = _interopRequireDefault(__webpack_require__(/*! ./context */ "./src/context.js"));
...
var ResourceContext = _react.default.createContext('get');
...
var _default = function _default(_ref) {
  ...
  var transform = rest.transform,
      path = rest.path,
      defaultValue = rest.defaultValue,
      _rest$params = rest.params,
      params = _rest$params === void 0 ? {} : _rest$params,
      _rest$headers = rest.headers,
      headers = _rest$headers === void 0 ? {} : _rest$headers,
      _rest$replace = rest.replace,
      replace = _rest$replace === void 0 ? {} : _rest$replace,
      _rest$memoize = rest.memoize,
      memoize = _rest$memoize === void 0 ? false : _rest$memoize;
  ...
  var _useContext = (0, _react.useContext)(_context2.default),
      ...
      apiUrl = _useContext.apiUrl,
      globalHeaders = _useContext.globalHeaders,
      afterGet = _useContext.afterGet;

  var replaceParams = function replaceParams(str) {
    return str.replace(/:(\w+)/, function (_, group) {
      return replace[group];
    });
  };

  name = replaceParams(name);
  var currentValue = getData(name) || defaultValue;
  var refreshName = "refresh.".concat(name);
  ...
  }, [name].concat(_toConsumableArray(paths), _toConsumableArray(Object.values(params)), _toConsumableArray(Object.values(headers))) //to be changed
  );
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              setBusy(name);
              requests = paths.map(function (pathName) {
                return (0, _axios.default)({
                  method: 'get',
                  url: "".concat(apiUrl, "/").concat(replaceParams(pathName)),
                  params: params,
                  headers: _objectSpread({}, globalHeaders(), {
                    headers: headers
                  })
                });
              });
...
var _context = __webpack_require__(/*! ./context */ "./src/context.js");

var _utils = __webpack_require__(/*! utils */ "./node_modules/utils/dist/index.js");
...
function (_Component) {
  ...
  function StateProvider(props) {
    ...
    _this = _possibleConstructorReturn(this, (StateProvider.__proto__ || Object.getPrototypeOf(StateProvider)).call(this, props));
    ...
    var _props$data = props.data,
        ...
        busy = _props$busy === void 0 ? {} : _props$busy,
        _props$shown = props.shown,
        shown = _props$shown === void 0 ? {} : _props$shown;
    _this.state = {
      data: _objectSpread({}, data),
      busy: _objectSpread({}, busy),
      shown: _objectSpread({}, shown)
    };
    return _this;
  }
  ...
  _createClass(StateProvider, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          _props$apiUrl = _props.apiUrl,
          apiUrl = _props$apiUrl === void 0 ? '' : _props$apiUrl,
          headers = _props.headers,
          afterGet = _props.afterGet,
          beforeSave = _props.beforeSave;
      var setData = this.setData,
          setBusy = this.setBusy,
          setShown = this.setShown,
          getData = this.getData,
          getBusy = this.getBusy,
          getShown = this.getShown,
...
var _initialiseProps = function _initialiseProps() {
  ...
  Object.defineProperty(this, "setData", {
    ...
    value: function value(path, _value) {
      ...
      (0, _utils.setPath)(data, path, _value);
  ...
  Object.defineProperty(this, "setBusy", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(path) {
      var _value2 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

      var busy = _this2.state.busy;
      (0, _utils.setPath)(busy, path, !!_value2);
  ...
  Object.defineProperty(this, "setShown", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(path) {
      var _value3 = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;

      var shown = _this2.state.shown;
      (0, _utils.setPath)(shown, path, !!_value3);
  ...
  Object.defineProperty(this, "getData", {
    ...
    value: function value(paths) {
      ...
      if (!paths) {
        ...
        return (0, _utils.getPath)(data, paths);
      }

      return paths.reduce(function (acc, path) {
        return _objectSpread({}, acc, _defineProperty({}, path, (0, _utils.getPath)(data, path)));
      }, {});
    }
  });
  Object.defineProperty(this, "getBusy", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(path) {
      var busy = _this2.state.busy;
      return !!(0, _utils.getPath)(busy, path);
    }
  });
  Object.defineProperty(this, "getShown", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(path) {
      var shown = _this2.state.shown;
      return !!(0, _utils.getPath)(shown, path);
    }
  });
  Object.defineProperty(this, "refreshResource", {
    configurable: true,
    enumerable: true,
    writable: true,
    value: function value(name) {
      window.dispatchEvent(new CustomEvent("refresh.".concat(name)));
    }
  });
};
...
var _default = function _default(_ref) {
  ...
  var _useContext = (0, _react.useContext)(_context.default),
      ...
      getBusy = _useContext.getBusy,
      globalHeaders = _useContext.globalHeaders,
      beforeSave = _useContext.beforeSave;

  var busyName = "save".concat(name);

  var save = function save(_ref2) {
    var key = _ref2.key,
        values = _objectWithoutProperties(_ref2, ["key"]);
    ...
    return new Promise(function (resolve, reject) {
      ...
      var fullApiUrl = "".concat(apiUrl, "/").concat(path.replace(/:(\w+)/, function (_, group) {
        return values[group];
      }));
...
var ResourceContext = _react.default.createContext('resource');
...
var _default = function _default(_ref) {
  ...
  var resourceData = getData(name) || defaultValue;
...
exports.Consumer = exports.Provider = exports.default = void 0;

var _react = _interopRequireDefault(__webpack_require__(/*! react */ "react"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Context = _react.default.createContext('store');
...
var _Get = _interopRequireDefault(__webpack_require__(/*! ./Get */ "./src/Get.js"));

var _Save = _interopRequireDefault(__webpack_require__(/*! ./Save */ "./src/Save.js"));

var _Delete = _interopRequireDefault(__webpack_require__(/*! ./Delete */ "./src/Delete.js"));

var _Provider = _interopRequireDefault(__webpack_require__(/*! ./Provider */ "./src/Provider.js"));

var _context = _interopRequireDefault(__webpack_require__(/*! ./context */ "./src/context.js"));

var _State = _interopRequireDefault(__webpack_require__(/*! ./State */ "./src/State.js"));
